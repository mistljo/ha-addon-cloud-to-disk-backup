...
ADDON_MAX_ARCHIVES="${ADDON_MAX_ARCHIVES:-4}"
ADDON_MAX_LOGS="${ADDON_MAX_LOGS:-5}"
ADDON_SPLIT_SIZE_MB="${ADDON_SPLIT_SIZE_MB:-10240}"
ADDON_COMPRESSION_LEVEL="${ADDON_COMPRESSION_LEVEL:-1}"
ADDON_THROTTLE_AUTO="${ADDON_THROTTLE_AUTO:-true}"
ADDON_SATA_CHUNK_MB="${ADDON_SATA_CHUNK_MB:-10}"
ADDON_SATA_PAUSE_SEC="${ADDON_SATA_PAUSE_SEC:-2}"
ADDON_USB_CHUNK_MB="${ADDON_USB_CHUNK_MB:-50}"
ADDON_USB_PAUSE_SEC="${ADDON_USB_PAUSE_SEC:-1}"
ADDON_DIRTY_RATIO="${ADDON_DIRTY_RATIO:-5}"
ADDON_DIRTY_BG_RATIO="${ADDON_DIRTY_BG_RATIO:-3}"
